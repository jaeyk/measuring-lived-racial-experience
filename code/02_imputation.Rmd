...
cleaned <- read.csv("/home/jae/analyzing-racial-lived-experience/processed_data/cleaned.csv")[,-1] # ignore the first column (=row numbers)
...
ggsave("/home/jae/analyzing-racial-lived-experience/outputs/missing_rate.png", height = 8)
```
