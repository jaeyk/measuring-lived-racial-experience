...
ggsave("/home/jae/analyzing-racial-lived-experience/outputs/factor_analysis.png", height = 6, width = 8)
...
factored <- rbind(data.frame("Weighted" = factor_df$micro_aggression[1:7] * micro_aggression[,2]),
...
ggsave("/home/jae/analyzing-racial-lived-experience/outputs/weighted_responses.png", width = 10)
