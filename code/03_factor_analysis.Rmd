...
Next, I visualized the relationship between factor loadings and three factors.
...
We are also interested to see how scores for these factors vary across racial groups. For example, it is curious to know whether the level of marginality varies across racial groups depending on which measure we use. I created index variables by calculating the mean of survey items related to each factor. I dropped the `name_mispronounced` variable in doing this, as its factor loading is quite low.
...
factored %>%
  ...
  ggplot(aes(x = reorder(race, mean), y = mean, ymax = upper.ci, ymin = lower.ci)) +
    ...
    labs(y= "Average score of survey responses", x = "Race",
         title = "Subgroup Descriptive Analysis",
         caption = "National Asian American Suvrey (2016)") +
