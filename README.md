...
Finally, I created three index variables, weighted average responses, by multiplying the average responses of questions related to each factor with their factor loadings. The blue point plot (weighted average respones) have narrower confidence intervals (or more reliable) than the red point plot (non-weighted average responses) in Figure 5.
